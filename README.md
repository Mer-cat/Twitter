...
**Twittier** is a basic twitter app to read and compose tweets the [Twitter API](https://apps.twitter.com/).
...
2. Different ways to encapsulate code
...
- [DateTools](https://github.com/MatthewYork/DateTools) - various tools for formatting date
